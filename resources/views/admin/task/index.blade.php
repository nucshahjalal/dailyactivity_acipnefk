        ...
        {{-- <div class="col-lg-12">
            <div class="card"> --}}
                <div class="card-title">
                    ...
                    <form action="{{ route('admin.task_on_my_supervision') }}" method="get" class="form-inline mt-1">
                    @else
                    <form action="{{ route('admin.task_all_employee') }}" method="get" class="form-inline mt-1">
                    @endif
                        @php
                            $start_date=null;
                        ...
                        @endphp
                        <div class="form-group mb-2 d-flex align-items-center me-5">
